...
import { History, LayoutDashboard, LogOut, Map, Settings, Users } from "lucide-react"
...
const sidebarLinks = [
  ...
  { href: "/admin/logs", label: "Registro de Actividad", icon: History },  { href: "/admin/configuracion", label: "Configuración", icon: Settings },
]
